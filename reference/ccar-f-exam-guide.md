# CCAR-F Exam Guide — Objectives Reference

Extracted verbatim from the official **Claude Certified Architect – Foundations Exam
Guide**, version 1.0, effective July 2026, exam code CCAR-F.
...
- **30** task statements
- **240** `Knowledge of:` / `Skills in:` bullets across them

Those 240 bullets are what the exam says it tests. They are the denominator for any
coverage claim the pipeline makes.
