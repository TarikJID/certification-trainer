...
- Concept: Ambiguous or overlapping tool descriptions cause misrouting [task 2.1]
  Type: key
...
- Concept: Tool-set size and selection reliability [task 2.3]
  Type: key
...
- Concept: tool_choice — controlling how Claude selects tools (auto, any, tool, none) [task 2.3]
  Type: key
...
- Concept: Structured error categorization and retryability (transient, validation, permission, business-logic) [task 2.2]
  Type: key
...
- Concept: Distinguishing access/permission failures from valid empty results [task 2.2]
  Type: key
...
- Concept: Environment variable expansion in .mcp.json for credential management [task 2.4]
  Type: key
...
- Concept: MCP resources as an addressable content catalog [task 2.4]
  Type: key
...
- Concept: Functional selection among Claude Code's file and search tools (Grep, Glob, Read, Write, Edit) [task 2.5]
  Type: key
